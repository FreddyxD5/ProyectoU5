...
4.-La vista creada para el modelo de servicios debe ser estática, por lo que debe contar únicamente con el método GET.(Terminado)

5.-La vista creada para el modelo Expired_payments, sólo debe admitir GET y POST(Terminado)

6.-Añadir Paginación de 100 resultados por página.(X)

7.-Añadir filtro de búsqueda en Payment_user para los campos de fecha de pago y fecha de expiración.(X)
...
10.-Generar la documentación de toda su API.(Pendiente)
"""